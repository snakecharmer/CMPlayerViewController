...
**/
public protocol CMPlayerViewControllerDelegate {
    /**
 ...
 */
public class CMPlayerViewController : UIViewController {
    ...
    public var delegate : CMPlayerViewControllerDelegate?
    ...
    public init(url : String) {
        self.url = url
        super.init(nibName: "CMPlayerViewController", bundle:  NSBundle(forClass: self.dynamicType))
    ...
    override public func viewWillAppear(animated: Bool) {
        ...
        self.mSlider.setThumbImage(UIImage(named: "tik_player", inBundle: self.bundle(), compatibleWithTraitCollection: nil)?.imageWithRenderingMode(.AlwaysTemplate), forState: .Normal)
        if (self.url != nil) {
    ...
    private func createVolumeView() {
        ...
        volumeView.setVolumeThumbImage(UIImage(named: "tik_player", inBundle: self.bundle(), compatibleWithTraitCollection: nil)?.imageWithRenderingMode(.AlwaysTemplate), forState: .Normal)
    ...
    @IBAction func play() {
        if (self.isPlaying()){
            ...
            self.playButton.setImage(UIImage(named: "play",  inBundle: self.bundle(), compatibleWithTraitCollection: nil), forState: .Normal)
        }else{
              self.playButton.setImage(UIImage(named: "pause",  inBundle: self.bundle(), compatibleWithTraitCollection: nil), forState: .Normal)
            self.player?.play()
        }
    }
